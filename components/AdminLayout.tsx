...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-[#FEFBF5] flex flex-col font-sans selection:bg-[#E09D3D] selection:text-[#AA1B2A]">
      {/* Main Admin Wrapper */}
      <div className="flex-1 flex overflow-hidden">
        {/* Sidebar for Desktop */}
        <aside className="hidden lg:flex flex-col w-64 bg-gradient-to-b from-[#AA1B2A] to-[#80101C] text-[#FEFBF5] border-r border-[#E09D3D]/30 shadow-2xl flex-shrink-0">
          {/* Brand Header */}
          <div className="p-4 border-b border-[#E09D3D]/20 flex items-center gap-3">
          ...
          {userRole === 'SUPER_ADMIN' && (
            <div className="p-3 border-t border-[#E09D3D]/20 bg-black/20">
              <Link
                href="/superadmin"
          ...
          {/* User Status Bar */}
          <div className="p-3 border-t border-[#E09D3D]/20 bg-black/30 flex items-center justify-between">
        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
          {/* Top Bar */}
          <header className="h-14 bg-white border-b border-[#E8E1D6] px-4 flex items-center justify-between shadow-2xs no-print">
