...
import { playNewOrderChime, unlockAudioContext } from '@/lib/sound';
...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  // Real-time Live QR Order Listener (Sound chime & popup for Customer QR Menu orders)
  useEffect(() => {
    unlockAudioContext();
    ...
    checkLatestOrders();
    const interval = setInterval(checkLatestOrders, 2500);
